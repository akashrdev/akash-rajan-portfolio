...
const ProjectList = () => {
  return (
    <div>
      <div className="flex flex-col lg:flex-row space-y-4 lg:space-x-6 lg:space-y-0 align-middle justify-center">
        <div className="flex flex-row space-x-4 md:space-x-6 justify-center">
          <WiskyBusiness />
          <Aficionado />
        </div>

        <div className="flex flex-row space-x-4 lg:space-x-6 justify-center">
          <Atelier />
          <PHP />
        </div>
      </div>
